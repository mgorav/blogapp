...
import com.gm.store.repository.EntryRepository;
import com.gm.store.repository.search.EntrySearchRepository;
...
import static com.gm.store.web.rest.TestUtil.sameInstant;
import static com.gm.store.web.rest.TestUtil.createFormattingConversionService;
...
public class EntryResourceIntTest {
    ...
    public void setup() {
        ...
        final EntryResource entryResource = new EntryResource(entryRepository, entrySearchRepository);
    ...
    public void createEntry() throws Exception {
        ...
        assertThat(testEntry.getDate()).isEqualTo(testEntry.getDate());
        assertThat(entryEs).isEqualToIgnoringGivenFields(testEntry, "date");
    }
