package com.gm.store.repository;

import com.gm.store.BlogappApp;
import com.gm.store.config.Constants;
import com.gm.store.config.audit.AuditEventConverter;
import com.gm.store.domain.PersistentAuditEvent;
...
import static com.gm.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
